...
from foba_backtest_engine.components.order_book.builders.multi_book_builder import MultiBookBuilder

@provides('pybuilders')
def pybuilders(pybuilder_exchange, 
               filter, 
    ...
    book_builder = MultiBookBuilder(exchange=pybuilder_exchange,
    ...
    return ImmutableDict((book_id, builder) for book_id, builder in book_builder.books.items())