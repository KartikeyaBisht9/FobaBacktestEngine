...
from foba_backtest_engine.utils.FeeTickScheduler.Calculator import (
    _calculate_fee,
    _calculate_tick_size,
    default_static_data_info_enrichment,
)
        ...
        for event_id, event in foba_events.items():
            ...
            yield (
                ...
                StaticDataEnrichment(
                    ...
                    fees=_calculate_fee(book_info, event, excluded_fee_names)
                    * currency_rate,
                ),
            )
